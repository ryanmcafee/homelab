...
|---|---|
| [operator-model.md](operator-model.md) — reconciliation boundaries, CRD design, idempotency, what an operator must expose | ADR-024 |
| [event-contract.md](event-contract.md) — CloudEvents envelope, NATS subject taxonomy, delivery guarantee per path | ADR-025 |
| [sdk-boundary.md](sdk-boundary.md) — the shared SDK/API surface and how compatibility is tested | ADR-026 |
| [byo-extension-points.md](byo-extension-points.md) — bring-your-own cloud, key, identity centre, agent identity | ADR-027 |
| [fork-ability.md](fork-ability.md) — the fork-ability contract as a checkable rule | ADR-028 |
| [quality-gates.md](quality-gates.md) — contract tests, schema compatibility, upgrade and rollback | ADR-029 |
