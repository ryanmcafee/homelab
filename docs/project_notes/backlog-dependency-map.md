...
Resolved as **ADR-030**: the distributable CLI stays Go, repository scripting stays
...
(ADR-024…ADR-030) and `docs/contracts/` are the architecture pages #49 would otherwise have to
