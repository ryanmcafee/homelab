...
**Consequences:**
- Every chart change needs `task test:snapshot -- --update` when the render legitimately changes; Renovate PRs get snapshots regenerated by CI with a diff comment
