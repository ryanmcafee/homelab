...
```bash
task localdev:up        # Kind (Cilium, registry caches, fakes) → ArgoCD → all 84 Applications synced from your working tree
...
34 addons and 16 applications, 84 ArgoCD Applications in all. The full table with chart versions,
