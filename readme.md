...
| GitOps | app-of-apps: `gitops` → `bootstrap` → 33 addons → 16 applications, plus per-PR previews | [`charts/`](charts/) |
...
33 addons and 16 applications, 85 ArgoCD Applications in all. The full table with chart versions,
