...
rg -i "connection refused" docs/project_notes/bugs.md

# Find bugs by date range
rg "2025-01" docs/project_notes/bugs.md
```

**Search decisions.md:**
```bash
# Check for decisions about a technology
rg -i "database" docs/project_notes/decisions.md

# Find all ADRs
rg "^### ADR-" docs/project_notes/decisions.md
```

**Search key_facts.md:**
```bash
# Find database connection info
rg -A 5 "Database" docs/project_notes/key_facts.md

# Look up service accounts
rg -i "service account" docs/project_notes/key_facts.md
```
